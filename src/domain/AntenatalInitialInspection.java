...
public class AntenatalInitialInspection {
    private Integer id;
    //保健册号
	...
	public String toString() {
		return "AntenatalInitialInspection [id=" + id + ", healthcode=" + healthcode + ", peidnumber=" + peidnumber
				+ ", prename=" + prename + ", prephonenumber=" + prephonenumber + ", lastmenstruationdate="
				+ lastmenstruationdate + ", initialinspectionweek=" + initialinspectionweek + ", epectedchildbirthdate="
				+ epectedchildbirthdate + ", pegnantcount=" + pegnantcount + ", productioncount=" + productioncount
				+ ", height=" + height + ", weight=" + weight + ", systolicpressure=" + systolicpressure
				+ ", diastolicpressure=" + diastolicpressure + ", heart=" + heart + ", lung=" + lung + ", vaginitis="
				+ vaginitis + ", cervicitis=" + cervicitis + ", dublevaginaanduterus=" + dublevaginaanduterus
				+ ", myomauterus=" + myomauterus + ", anexalmass=" + anexalmass + ", uterussizeationalweek="
				+ uterussizeationalweek + ", vaginalbleeding=" + vaginalbleeding + ", vomiting=" + vomiting + ", fever="
				+ fever + ", viralinfection=" + viralinfection + ", acyeterion=" + acyeterion + ", urineprotein="
				+ urineprotein + ", leucorrhea=" + leucorrhea + ", bloodsugar=" + bloodsugar + ", toxoplasma="
				+ toxoplasma + ", alphafetoprotein=" + alphafetoprotein + ", cytomegalovirus=" + cytomegalovirus
				+ ", gptoralt=" + gptoralt + ", rubellavirus=" + rubellavirus + ", hbsag=" + hbsag + ", syphilis="
				+ syphilis + ", bloodtype=" + bloodtype + ", highriskevaluate=" + highriskevaluate
				+ ", anteriorsuperiorspine=" + anteriorsuperiorspine + ", anterioriliac=" + anterioriliac
				+ ", sacroiliacexternaldiameter=" + sacroiliacexternaldiameter + ", sciatictubercle=" + sciatictubercle
				+ ", checkdate=" + checkdate + ", fillperson=" + fillperson + ", inputperson=" + inputperson
				+ ", heartdetails=" + heartdetails + ", lungdetails=" + lungdetails + ", vaginitisdetails="
				+ vaginitisdetails + ", cervicitisdetails=" + cervicitisdetails + ", dublevaginaanduterusdetails="
				+ dublevaginaanduterusdetails + ", myomauterusdetails=" + myomauterusdetails + ", aexalmassdetails="
				+ aexalmassdetails + ", uterussizeationalweekdetails=" + uterussizeationalweekdetails
				+ ", otherquestions=" + otherquestions + ", othercheckdetails=" + othercheckdetails
